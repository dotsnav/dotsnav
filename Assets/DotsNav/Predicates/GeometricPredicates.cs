...
namespace RobustGeometricPredicates
{
    ...
    public static unsafe class GeometricPredicates
    {
        ...
        public static double Orient2DFast(double2 pa, double2 pb, double2 pc)
        {
        ...
        internal static double Orient2DExact(double2 pa, double2 pb, double2 pc)
        {
        ...
        internal static double Orient2DSlow(double2 pa, double2 pb, double2 pc)
        {
            double acx, acy, bcx, bcy;
            double acxtail, acytail;
            double bcxtail, bcytail;
            double negate, negatetail;
            double* axby = stackalloc double[8];
            double* bxay = stackalloc double[8];
            double axby7, bxay7;
            double* deter = stackalloc double[16];
            int deterlen;
        ...
        /// area of the triangle defined by the three points.</returns>
        public static double Orient2D(double2 pa, double2 pb, double2 pc)
        {
        ...
        static double Orient2DAdapt(double2 pa, double2 pb, double2 pc, double detsum)
        {
            double acx, acy, bcx, bcy;
        ...
        public static double Orient3DFast(double2 pa, double2 pb, double2 pc, double2 pd)
        {
            double adx, bdx, cdx;
            double ady, bdy, cdy;
            double adz, bdz, cdz;
        ...
        internal static double Orient3DExact(double2 pa, double2 pb, double2 pc, double2 pd)
        {
            ...
            double* adet = stackalloc double[24];
            double* bdet = stackalloc double[24];
            double* cdet = stackalloc double[24];
            double* ddet = stackalloc double[24];
            int alen, blen, clen, dlen;
            double* abdet = stackalloc double[48];
            double* cddet = stackalloc double[48];
            int ablen, cdlen;
            double* deter = stackalloc double[96];
            int deterlen;
            int i;
        ...
        internal static double Orient3DSlow(double2 pa, double2 pb, double2 pc, double2 pd)
        {
            ...
            double* axby = stackalloc double[8];
            double* bxcy = stackalloc double[8];
            double* axcy = stackalloc double[8];
            double* bxay = stackalloc double[8];
            double* cxby = stackalloc double[8];
            double* cxay = stackalloc double[8];
            double* temp16 = stackalloc double[16];
            double* temp32 = stackalloc double[32];
            double* temp32t = stackalloc double[32];
            int temp16len, temp32len, temp32tlen;
            double* adet = stackalloc double[64];
            double* bdet = stackalloc double[64];
            double* cdet = stackalloc double[64];
            int alen, blen, clen;
            double* abdet = stackalloc double[128];
            int ablen;
            double* deter = stackalloc double[192];
            int deterlen;
        ...
        public static double Orient3D(double2 pa, double2 pb, double2 pc, double2 pd)
        {
        ...
        static double Orient3DAdapt(double2 pa, double2 pb, double2 pc, double2 pd, double permanent)
        {
            double adx, bdx, cdx, ady, bdy, cdy, adz, bdz, cdz;
            double det, errbound;
        ...
        public static double InCircleFast(double2 pa, double2 pb, double2 pc, double2 pd)
        {
        ...
        internal static double InCircleExact(double2 pa, double2 pb, double2 pc, double2 pd)
        {
            double axby1, bxcy1, cxdy1, dxay1, axcy1, bxdy1;
            double bxay1, cxby1, dxcy1, axdy1, cxay1, dxby1;
            double axby0, bxcy0, cxdy0, dxay0, axcy0, bxdy0;
        ...
        internal static double InCircleSlow(double2 pa, double2 pb, double2 pc, double2 pd)
        {
            ...
            double* temp16 = stackalloc double[16];
            int temp16len;
            double* detx = stackalloc double[32];
            double* detxx = stackalloc double[64];
            double* detxt = stackalloc double[32];
            double* detxxt = stackalloc double[64];
            double* detxtxt = stackalloc double[64];
            int xlen, xxlen, xtlen, xxtlen, xtxtlen;
            double* x1 = stackalloc double[128];
            double* x2 = stackalloc double[192];
            int x1len, x2len;
            double* dety = stackalloc double[32];
            double* detyy = stackalloc double[64];
            double* detyt = stackalloc double[32];
            double* detyyt = stackalloc double[64];
            double* detytyt = stackalloc double[64];
            int ylen, yylen, ytlen, yytlen, ytytlen;
            double* y1 = stackalloc double[128];
            double* y2 = stackalloc double[192];
            int y1len, y2len;
            double* adet = stackalloc double[384];
            double* bdet = stackalloc double[384];
            double* cdet = stackalloc double[384];
            double* abdet = stackalloc double[768];
            double* deter = stackalloc double[1152];
        ...
        public static double InCircle(double2 pa, double2 pb, double2 pc, double2 pd)
        {
            double adx, bdx, cdx, ady, bdy, cdy;
            double bdxcdy, cdxbdy, cdxady, adxcdy, adxbdy, bdxady;
            double alift, blift, clift;
        ...
        static double InCircleAdapt(double2 pa, double2 pb, double2 pc, double2 pd, double permanent)
        {
            double adx, bdx, cdx, ady, bdy, cdy;
            double det, errbound;
        ...
        public static double InSphereFast(double2 pa, double2 pb, double2 pc, double2 pd, double2 pe)
        {
        ...
        internal static double InSphereExact(double2 pa, double2 pb, double2 pc, double2 pd, double2 pe)
        {
            ...
            double* cdea = stackalloc double[96];
            ...
            int xlen, ylen, zlen;
            double* detxy = stackalloc double[768];
            int xylen;
        ...
        internal static double InSphereSlow(double2 pa, double2 pb, double2 pc, double2 pd, double2 pe)
        {
            ...
            double* axby = stackalloc double[8];
            double* bxcy = stackalloc double[8];
            double* cxdy = stackalloc double[8];
            double* dxay = stackalloc double[8];
            double* axcy = stackalloc double[8];
            double* bxdy = stackalloc double[8];
            double* bxay = stackalloc double[8];
            double* cxby = stackalloc double[8];
            double* dxcy = stackalloc double[8];
            double* axdy = stackalloc double[8];
            double* cxay = stackalloc double[8];
            double* dxby = stackalloc double[8];
            double* ab = stackalloc double[16];
            double* bc = stackalloc double[16];
            double* cd = stackalloc double[16];
            double* da = stackalloc double[16];
            double* ac = stackalloc double[16];
            double* bd = stackalloc double[16];
            int ablen, bclen, cdlen, dalen, aclen, bdlen;
            double* temp32a = stackalloc double[32];
            double* temp32b = stackalloc double[32];
            double* temp64a = stackalloc double[64];
            double* temp64b = stackalloc double[64];
            double* temp64c = stackalloc double[64];
            int temp32alen, temp32blen, temp64alen, temp64blen, temp64clen;
            double* temp128 = stackalloc double[128];
            double* temp192 = stackalloc double[192];
            int temp128len, temp192len;
            double* detx = stackalloc double[384];
            double* detxx = stackalloc double[768];
            double* detxt = stackalloc double[384];
            double* detxxt = stackalloc double[768];
            double* detxtxt = stackalloc double[768];
            int xlen, xxlen, xtlen, xxtlen, xtxtlen;
            double* x1 = stackalloc double[1536];
            double* x2 = stackalloc double[2304];
            int x1len, x2len;
            double* dety = stackalloc double[384];
            double* detyy = stackalloc double[768];
            double* detyt = stackalloc double[384];
            double* detyyt = stackalloc double[768];
            double* detytyt = stackalloc double[768];
            int ylen, yylen, ytlen, yytlen, ytytlen;
            double* y1 = stackalloc double[1536];
            double* y2 = stackalloc double[2304];
            int y1len, y2len;
            double* detz = stackalloc double[384];
            double* detzz = stackalloc double[768];
            double* detzt = stackalloc double[384];
            double* detzzt = stackalloc double[768];
            double* detztzt = stackalloc double[768];
            int zlen, zzlen, ztlen, zztlen, ztztlen;
            double* z1 = stackalloc double[1536];
            double* z2 = stackalloc double[2304];
            int z1len, z2len;
            double* detxy = stackalloc double[4608];
            int xylen;
            double* adet = stackalloc double[6912];
            double* bdet = stackalloc double[6912];
            double* cdet = stackalloc double[6912];
            double* ddet = stackalloc double[6912];
            int alen, blen, clen, dlen;
            double* abdet = stackalloc double[13824];
            double* cddet = stackalloc double[13824];
            double* deter = stackalloc double[27648];
            int deterlen;
            int i;
        ...
        public static double InSphere(double2 pa, double2 pb, double2 pc, double2 pd, double2 pe)
        {
            double aex, bex, cex, dex;
            double aey, bey, cey, dey;
            double aez, bez, cez, dez;
        ...
        static double InSphereAdapt(double2 pa, double2 pb, double2 pc, double2 pd, double2 pe, double permanent)
        {
            double aex, bex, cex, dex, aey, bey, cey, dey, aez, bez, cez, dez;
            double det, errbound;
